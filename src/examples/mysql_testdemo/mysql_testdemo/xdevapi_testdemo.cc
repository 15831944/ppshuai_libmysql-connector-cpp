...
try {
  ...
  Session s(url);
  //Session s("127.0.0.1", 33060, "test", "123456");
  /*Session s(
	  SessionOption::USER, "test",
	  SessionOption::PWD, "123456",
	  SessionOption::HOST, "127.0.0.1",
	  SessionOption::PORT, 33060,
	  SessionOption::DB, "testdb",
  ...
  */
    ...
    RowResult res = s.sql("show variables like 'version'").execute();
  ...
  s.dropSchema("testdb1");
  s.createSchema("testdb1");
  Schema sch= s.getSchema(s.getDefaultSchemaName());
