...
class UpdateOperation : public ::google::protobuf::MessageLite {
 public:
  ...
  static const UpdateType MERGE_PATCH = UpdateOperation_UpdateType_MERGE_PATCH;
...
class Find : public ::google::protobuf::MessageLite {
 public:
  ...
  static const RowLock SHARED_LOCK = Find_RowLock_SHARED_LOCK;
  static const RowLock EXCLUSIVE_LOCK = Find_RowLock_EXCLUSIVE_LOCK;
  ...
  static const RowLockOptions NOWAIT = Find_RowLockOptions_NOWAIT;
  static const RowLockOptions SKIP_LOCKED = Find_RowLockOptions_SKIP_LOCKED;
  ...
  inline bool has_locking() const;
  inline void clear_locking();
  static const int kLockingFieldNumber = 12;
  inline ::Mysqlx::Crud::Find_RowLock locking() const;
  inline void set_locking(::Mysqlx::Crud::Find_RowLock value);

  // optional .Mysqlx.Crud.Find.RowLockOptions locking_options = 13;
  inline bool has_locking_options() const;
  inline void clear_locking_options();
  static const int kLockingOptionsFieldNumber = 13;
  inline ::Mysqlx::Crud::Find_RowLockOptions locking_options() const;
  inline void set_locking_options(::Mysqlx::Crud::Find_RowLockOptions value);
 ...
 private:
  ...
  inline void set_has_locking();
  inline void clear_has_locking();
  inline void set_has_locking_options();
  inline void clear_has_locking_options();
...
class Insert : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_upsert() const;
  inline void clear_upsert();
  static const int kUpsertFieldNumber = 6;
  inline bool upsert() const;
  inline void set_upsert(bool value);
