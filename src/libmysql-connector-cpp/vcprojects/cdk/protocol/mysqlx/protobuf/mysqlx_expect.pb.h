...
class Open_Condition : public ::google::protobuf::MessageLite {
 public:
  ...
  static const Key EXPECT_NO_ERROR = Open_Condition_Key_EXPECT_NO_ERROR;
  static const Key EXPECT_FIELD_EXIST = Open_Condition_Key_EXPECT_FIELD_EXIST;
  static const Key EXPECT_DOCID_GENERATED = Open_Condition_Key_EXPECT_DOCID_GENERATED;
