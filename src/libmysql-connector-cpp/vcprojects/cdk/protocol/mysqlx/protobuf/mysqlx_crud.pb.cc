  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 11: {
        ...
        if (input->ExpectTag(90)) goto parse_args;
        if (input->ExpectTag(96)) goto parse_locking;
        break;
      }
      ...
      case 12: {
        ...
        if (input->ExpectTag(104)) goto parse_locking_options;
        break;
      }
...
void Find::MergeFrom(const Find& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_locking_options()) {
      set_locking_options(from.locking_options());
    }
  }
  mutable_unknown_fields()->append(from.unknown_fields());
}
...
void Find::Swap(Find* other) {
  if (other != this) {
    ...
    std::swap(locking_, other->locking_);
    std::swap(locking_options_, other->locking_options_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.swap(other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
